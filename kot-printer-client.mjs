#!/usr/bin/env node
/**
 * Taiwan Maami KOT Printer Client - T. NAGAR (BAR)
 * 
 * Printer: BAR
 * IP: 192.168.1.23
 * Port: 9100
...
async function startPolling() {
  console.log('🖨️  Taiwan Maami KOT Printer Client - T. NAGAR (BAR) v2.0');
  console.log('==========================================================');
  ...
  console.log('==========================================================\n');
  console.log('✅ Started polling for KOTs (T. NAGAR BAR)...\n');
...
process.on('SIGINT', () => {
  console.log('\n\n👋 Shutting down T. NAGAR BAR KOT printer client...');
  process.exit(0);
});
