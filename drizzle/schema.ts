...
export const orders = mysqlTable("orders", {
  ...
  paymentCollectedBy: varchar("paymentCollectedBy", { length: 255 }), // Staff/admin name who collected/confirmed payment
...
export const eventInquiries = mysqlTable("event_inquiries", {
  ...
  cateringType: mysqlEnum("cateringType", ["beverages_only", "food_only", "both"]).notNull(),
  preferredItems: text("preferredItems"),
  budgetRange: varchar("budgetRange", { length: 50 }),
  specialRequirements: text("specialRequirements"),
  status: mysqlEnum("status", ["new", "contacted", "quoted", "confirmed", "cancelled"]).default("new").notNull(),
